    ...
    <div class="container position-relative">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">             
                ...
                <li class="nav-item">
                <a class="nav-link" href="#">Contacto y soporte</a>
                </li>
            </ul>

            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">    
                <a class="btn btn-outline-primary text-white me-3" 
                href="?pid=<?php echo base64_encode("presentacion/registroCliente.php")?>">
            ...
            <div class="row">
                <div class="col-12 col-md-6 mb-3 mb-md-0 text-center py-5">
                    <p>Prepara todo para tu viaje y registrate en nuestra pagina para comprar tus tiketes de manera facil y rapida.
                        ...
                        href="<?php echo base64_encode("presentacion/registroCliente.php")?>">
    ...
    <div class="container position-relative">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <p><strong>© 2025 Zefiro Aerolinea, Inc</strong></p>
            </div>
